...
enum ZenFSNewMetricsHistograms : uint32_t {
  ZENFS_FILE_READ,
  ZENFS_FILE_WRITE,
  ZENFS_FILE_SYNC,
  ZENFS_IOZONE_ALLOC,
  ZENFS_METADATA_ALLOC,
  ZENFS_ROLL,
};

// Types of Reporter that may be used for statistics.
enum ZenFSNewMetricsReporterType : uint32_t {
  ZENFS_REPORTER_TYPE_RUNTIME_SECOND,
  ZENFS_REPORTER_TYPE_OPS,
  ZENFS_REPORTER_TYPE_SPACE_GB
};
